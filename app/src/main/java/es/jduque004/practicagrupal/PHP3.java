...
public class PHP3 extends AsyncTask<Void, Void, String> {
    public PHP3(String nombre,String estilo) throws MalformedURLException {
        Nombre = nombre;
        Estilo = estilo;
    }
    ...
    public PHP3() throws IOException {
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            URL targetURL = new URL(Update+"?Nombre="+Nombre+"&Estilo="+Estilo);
